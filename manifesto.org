...
modes to view the objects and edit the network of relationships.
...
the views will become in terms of structure. 

The author can choose how much they want to "fix" the
