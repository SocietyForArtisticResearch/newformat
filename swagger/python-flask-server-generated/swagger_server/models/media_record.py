...
from swagger_server.models.media_record_recrod_type import MediaRecordRecrodType  # noqa: F401,E501
...
class MediaRecord(Model):
    ...
    """
    def __init__(self, id: str=None, text: MediaRecordText=None, title: str=None, copyright: str=None, license: str=None, description: str=None, creator: str=None, media_type: str=None, parents: List[str]=None, keywords_closed: List[str]=None, keywords_open: List[str]=None, tags: List[str]=None, recrod_type: MediaRecordRecrodType=None, creation_date: date=None, modified_date: date=None, media_date: date=None, connections: List[Connection]=None):  # noqa: E501
        ...
        :type tags: List[str]
        :param recrod_type: The recrod_type of this MediaRecord.  # noqa: E501
        :type recrod_type: MediaRecordRecrodType
        ...
        self.swagger_types = {
            ...
            'tags': List[str],
            'recrod_type': MediaRecordRecrodType,
            'creation_date': date,
            'modified_date': date,
            'media_date': date,
    ...
    def keywords_closed(self) -> List[str]:
        ...
        closed vocabulary keywords ids, obtained by /keywords/closed  # noqa: E501
    ...
    def keywords_open(self) -> List[str]:
        ...
        open vocabulary keywords ids, obtained by /keywords/open  # noqa: E501
    ...
    @property
    def recrod_type(self) -> MediaRecordRecrodType:
        """Gets the recrod_type of this MediaRecord.


        :return: The recrod_type of this MediaRecord.
        :rtype: MediaRecordRecrodType
        """
        return self._recrod_type

    @recrod_type.setter
    def recrod_type(self, recrod_type: MediaRecordRecrodType):
        """Sets the recrod_type of this MediaRecord.


        :param recrod_type: The recrod_type of this MediaRecord.
        :type recrod_type: MediaRecordRecrodType
        """
